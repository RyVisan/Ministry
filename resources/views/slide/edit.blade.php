@extends('daskboard')
@section('function', 'កែស្លាយរូបភាព')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        <a href="{{route('img_slide.index')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-left"></i> <span style="font-family: 'Siemreap', cursive;">បញ្ជីស្លាយរូបភាព</span></a>
                    </h1>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-8 justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3><span style="font-family: 'Siemreap', cursive;">កែស្លាយរូបភាព</span></h3>
                        </div>
                        <div class="card-body">
                            <form action="{{route('img_slide.update',$img_slides->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <label for="exampleInputEmail1" class="form-label"><span style="font-family: 'Siemreap', cursive;">ចំណងជើងស្លាយរូបភាព :</span></label>
                                <input placeholder="សូមបញ្ជូលឈ្មោះចំណងជើងយ៉ាងតិច៣តួរអក្សរ" style="font-family: 'Siemreap', cursive;" type="text" name="slide_title" value="{{old('slide_title',$img_slides->slide_title)}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                @error('slide_title')
                                ...
                                <textarea name="description" cols="30" rows="4" class="form-control"​style="font-family: 'Siemreap', cursive;">{{old('description',$img_slides->description)}}</textarea>
                                <br><label for="exampleInputEmail1" class="form-label"><span style="font-family: 'Siemreap', cursive;">រូបភាព :</span></label>
                                <input type="file" name="image"><br>
                                <img src="{{asset('uploads/images_slide/'.$img_slides->image)}}" width="50" height="50" alt="">
                                @error('image')
                                <br><span class="text-danger" style="font-family: 'Siemreap', cursive;">{{ $message }}</span>
                                @enderror
                                ...
                                <input placeholder="សូមបញ្ជូលលេខយ៉ាងតិច១" style="font-family: 'Siemreap', cursive;" type="text" name="order_by" value="{{old('order_by',$img_slides->order_by)}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                @error('order_by')
                                <span class="text-danger" style="font-family: 'Siemreap', cursive;">{{ $message }}</span><br>
                                @enderror
