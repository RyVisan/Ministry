                ...
                <div class="col-8 justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3><span style="font-family: 'Siemreap', cursive;">បង្កើតកម្មវិធីផ្សេងៗ</span></h3>
                        </div>
                        <div class="card-body">
                            <form action="{{route('other.save')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <label for="exampleInputEmail1" class="form-label"><span style="font-family: 'Siemreap', cursive;">ចំណងជើងកម្មវិធី :</span></label>
                                <input placeholder="សូមបញ្ជូលចំណងជើងយ៉ាងតិច៣តួរអក្សរ" style="font-family: 'Siemreap', cursive;" type="text" name="name" value="{{old('name')}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                @error('name')
